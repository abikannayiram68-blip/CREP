...
function Header() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "header",
    {
      className: `fixed top-0 inset-x-0 z-50 transition-all duration-300 ${scrolled ? "bg-background/85 backdrop-blur-xl border-b border-border shadow-soft" : "bg-transparent"}`,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl container-px flex h-16 md:h-20 items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/", className: "flex items-center gap-2.5 group", "aria-label": "CREP home", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "grid place-items-center h-9 w-9 rounded-lg bg-gradient-hero text-primary-foreground shadow-soft group-hover:scale-105 transition-transform", children: /* @__PURE__ */ jsxRuntimeExports.jsx(BookOpen, { className: "h-5 w-5", "aria-hidden": true }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display text-lg md:text-xl font-bold tracking-tight", children: "CREP" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "hidden lg:flex items-center gap-8", "aria-label": "Primary", children: [
            ...
            anchorItems.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                onClick: () => scrollToSection(item.href.slice(1)),
                className: "text-sm font-medium text-foreground/80 hover:text-foreground transition-colors story-link",
        ...
        open && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "lg:hidden border-t border-border bg-background/95 backdrop-blur-xl", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "mx-auto max-w-7xl container-px py-4 flex flex-col gap-1", "aria-label": "Mobile", children: [
          navItems.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              onClick: () => scrollToSection(item.href.slice(1)),
...
function Footer() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: "mt-24 border-t border-border bg-gradient-subtle", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl container-px py-14 grid gap-10 md:grid-cols-2 lg:grid-cols-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/", className: "flex items-center gap-2.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "grid place-items-center h-9 w-9 rounded-lg bg-gradient-hero text-primary-foreground shadow-soft", children: /* @__PURE__ */ jsxRuntimeExports.jsx(BookOpen, { className: "h-5 w-5", "aria-hidden": true }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display text-xl font-bold", children: "CREP" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 text-sm text-muted-foreground leading-relaxed max-w-xs", children: "Chinmay Research Education and Publication — empowering academia through publications, conferences and innovation." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-5 flex items-center gap-3", children: [
          { Icon: Linkedin, label: "LinkedIn" },
          { Icon: Twitter, label: "Twitter" },
          { Icon: Facebook, label: "Facebook" },
          { Icon: Youtube, label: "YouTube" }
        ].map(({ Icon: Icon2, label }) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "a",
          {
            href: "#",
            "aria-label": label,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-sm font-semibold uppercase tracking-wider", children: "Quick Links" }),
        ...
        ].map((l) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: l.to, className: "text-muted-foreground hover:text-foreground transition-colors", children: l.label }) }, l.to)) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-sm font-semibold uppercase tracking-wider", children: "Services" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "mt-4 space-y-2.5 text-sm text-muted-foreground", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "Journal Publication" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "Conferences & Workshops" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "Thesis & Article Writing" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "Software & Web Development" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "Plagiarism Checking" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-sm font-semibold uppercase tracking-wider", children: "Contact" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "mt-4 space-y-3 text-sm text-muted-foreground", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex gap-3", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "D-2/541, Vikalp Khand, Gomti Nagar, Lucknow-226010" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Mail, { className: "h-4 w-4 mt-0.5 shrink-0 text-primary" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "mailto:care@creppvtltd.com", className: "hover:text-foreground transition-colors", children: "care@creppvtltd.com" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { className: "h-4 w-4 mt-0.5 shrink-0 text-primary" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "tel:+918299178291", className: "hover:text-foreground transition-colors", children: "+91 82991 78291" })
          ] })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-t border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl container-px py-5 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-muted-foreground", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
        "© ",
        (/* @__PURE__ */ new Date()).getFullYear(),
        " CREP Pvt Ltd. All rights reserved."
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "ISO 9001:2015 Certified · Made with care in India" })
    ] }) })
  ] });
}
const appCss = "/assets/styles-DQLgPDam.css";
function NotFoundComponent() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex min-h-screen items-center justify-center bg-gradient-subtle px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-md text-center", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "mt-4 font-display text-2xl font-semibold", children: "Page not found" }),
...
const Route$6 = createRootRoute({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "CREP (Chinmay Research Education and Publication) supports academia with peer-reviewed journals, international conferences, research guidance and software development."
      },
      ...
      { property: "og:title", content: "CREP — Research, Publication & Innovation" },
      {
        ...
        content: "Empowering academia through publications, conferences, training and research-driven software development."
      },
...
function RootComponent() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { id: "main", className: "min-h-screen", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Outlet, {}) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Footer, {})
  ] });
}
const $$splitComponentImporter$5 = () => import("./services-LzfsHs5P.js");
const Route$5 = createFileRoute("/services")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Explore CREP services: peer-reviewed journal publication, international conferences, thesis & article writing, software R&D and plagiarism checking."
    }, {
      property: "og:title",
      content: "CREP Services — Publication, Conferences & R&D"
    }, {
      property: "og:description",
      content: "End-to-end services for researchers: from manuscript to indexed publication, conference participation and full-stack software development."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const $$splitComponentImporter$4 = () => import("./research-DhzE80K2.js");
const Route$4 = createFileRoute("/research")({
  head: () => ({
    meta: [{
      title: "Research & Development — Software, Web & AI | CREP"
    }, {
      name: "description",
      content: "CREP's R&D team builds production-grade software in Java, Node.js, React, Next.js, Flutter and AI — for academic and enterprise needs."
    }, {
      property: "og:title",
      content: "CREP Research & Development"
    }, {
      property: "og:description",
      content: "Software, website and mobile application development with deep AI/ML expertise."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./publications-Vnnp6B2y.js");
const Route$3 = createFileRoute("/publications")({
  head: () => ({
    meta: [{
      title: "Publications & Journals | CREP"
    }, {
      name: "description",
      content: "Peer-reviewed journals from CREP — IJDIIC, IJETCC, JIEEE, JASE and JMSS — covering computing, electronics, applied science and management."
    }, {
      property: "og:title",
      content: "CREP Journals & Publications"
    }, {
      property: "og:description",
      content: "Five scholarly peer-reviewed journals plus publication guidance for thesis, articles, proposals and implementation."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./contact-BSnQxF9c.js");
const Route$2 = createFileRoute("/contact")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Get in touch with CREP for publication, conferences, training or R&D. Reach us via email, phone or visit our Lucknow office."
    }, {
      property: "og:title",
      content: "Contact CREP"
    }, {
      property: "og:description",
      content: "Email care@creppvtltd.com or call +91 82991 78291 — our team responds within one business day."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./about-D_lg1qMh.js");
const Route$1 = createFileRoute("/about")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Learn about CREP Pvt. Ltd. — an ISO 9001:2015 certified research, publication and innovation alliance helping academics publish and grow globally."
    }, {
      property: "og:title",
      content: "About CREP — Multinational Research Alliance"
    }, {
      property: "og:description",
      content: "Our mission, vision and values: bridging research, industry and society through ethical scholarly excellence."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./index-DuVBPHOT.js");
const Route2 = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "CREP supports research, publication, conferences and R&D with ISO 9001:2015 certification, publication guidance, Turnitin checks, and global research services."
    }, {
      property: "og:title",
      content: "Chinmay Research Education and Publication Pvt. Ltd."
    }, {
      property: "og:description",
      content: "A multinational alliance for research, publication, conferences, training and software development for scholars worldwide."
    }]
  }),
...
const ResearchRoute = Route$4.update({
  id: "/research",
  path: "/research",
  getParentRoute: () => Route$6
});
const PublicationsRoute = Route$3.update({
  id: "/publications",
  path: "/publications",
  getParentRoute: () => Route$6
});
